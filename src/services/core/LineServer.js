            ...
            const req = https.request(url, {
                ...
                res.on('end', () => {
                    ...
                    try {
                        ...
                        if (encoding === 'gzip') responseData = zlib.gunzipSync(responseData);
                        if (encoding === 'deflate') responseData = zlib.inflateSync(responseData);
                        if (encoding === 'br') responseData = zlib.brotliDecompressSync(responseData);
                        let parsedResponse;
